...
# predicting_student_performance documentation build
...
from predicting_student_performance import __version__ as release

# -- Project information -----------------------------------------------------

project = "predicting_student_performance"
author = "Kedro"
...
htmlhelp_basename = "predicting_student_performancedoc"
...
latex_documents = [
    (
        master_doc,
        "predicting_student_performance.tex",
        "predicting_student_performance Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "predicting_student_performance",
        "Project predicting_student_performance codebase.",
        "Data-Science",
    )
]
