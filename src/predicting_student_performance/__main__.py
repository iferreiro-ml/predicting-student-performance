"""Predicting Student Performance file for ensuring the package is executable
as `predicting-student-performance` and `python -m predicting_student_performance`
"""
import importlib
